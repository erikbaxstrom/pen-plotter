...
; paint
G1 F2300.0 X400 Y200 Z-3.3
; paint
G1 F2300.0 X400 Y0 Z-3.3
; paint
G1 F2300.0 X300 Y0 Z-3.3
;
;End of Gcode
"""
    file_manager.add_to_print_file(test_print_file_string.encode('utf-8'))
    assert file_manager.print_string == test_print_file_string, f"assert file_manager.print_string == test_print_file_string"
    print('success!')
